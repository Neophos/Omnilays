...
$(function() {
    ...
    function updateScreen() {
        ...
        if(replicantCurrentMatchData.value[0].name == previousMatchData.value[0].name && replicantCurrentMatchData.value[0].flag != previousMatchData.value[0].flag)
        {
            setFlags(1);
        }
        if(replicantCurrentMatchData.value[1].name == previousMatchData.value[1].name && replicantCurrentMatchData.value[1].flag != previousMatchData.value[1].flag)
        {
            setFlags(2);
        }
